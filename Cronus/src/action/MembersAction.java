...
public class MembersAction extends BaseServlet {
    ...
    //会员条件查询
    public String getMemberListPage(String nick_name, String phone, String status, String member_level,String registration_time, String endDate, String source, String page, String limit) throws Exception {
        int pageI = Integer.valueOf(page);
        int end = Integer.valueOf(limit);
        return MembersService.getMemberListPage(nick_name, phone, status,member_level, registration_time, endDate, source, (pageI - 1) * end, end);
    }

...
public class MembersService extends BaseService {
    ...
    //根据条件查询会员
    public static String getMemberListPage(String nick_name,String phone,String status,String member_level,String registration_time1,String endDate ,String source,int page,int limit) throws Exception {
        StringBuffer sql = new StringBuffer();

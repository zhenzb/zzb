    ...
    layui.use(['element','laydate','table'], function(){
        ...
        table.render({
            ...
            ,cols: [[
                ...
                ,{field:'id', width:60, title: 'ID',align:'center',fixed: 'left'}
                ,{field:'position_id', width:200, title: '广告位链接名称',align:'center',fixed: 'left'}
                ,{field:'position_name', width:250, title: '备注',align:'center',fixed: 'left'}
                ,{field:'status', width:200, title: 'URL链接',align:'center',fixed: 'left'}
                ,{field:'operator', width:150, title: '最后操作人',align:'center'}
                ,{field:'edit_time', width:160, title: '最后操作时间',align:'center',templet:function (d) {
                    var index="";
                    if(d.edit_time==""){
                        index="----";
                    }else {

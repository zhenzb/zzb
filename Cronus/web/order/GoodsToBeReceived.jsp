...
<script>
    ...
    layui.use(['laydate', 'layer', 'table', 'element'], function () {
        ...
        table.render({
            elem: '#ToBePaid'
            , height: 600
            , url: '${ctx}/order?method=getOrderByStatusWaitRecGoods' //数据接口
            , page: true //开启分页
            , limit: 100
            ...
            , cols: [[ //表头
                ...
                {field: 'transaction_no', width: 200, title: '订单编号',align:'center'}
                ...
                , {field: 'score', width: 160, title: '操作', align:'center',sort: true, toolbar: "#barDemo"}
            ]]
...
<script type="text/html" id="barDemo">
    ...
    <%-- <a class="layui-btn layui-btn-sm" onclick="agree('{{d.id}}')">订单处理</a>--%>
</script>

...
<script>
    ...
    layui.use(['laydate', 'layer', 'table', 'element'], function () {
        ...
        table.render({
            elem: '#ToBePaid'
            , height: 600
            , url: '${ctx}/order?method=getOrderByStatusRecGoods'
            , cols: [[
                ...
                , {field: 'order_type', width: 90, title: '类型',align:'center', templet: '#order_typeTpl'}
                , {field: 'sign', width: 100, title: '发货仓库',align:'center', templet: '#signTpl'}
                ...
                , {field: 'created_date', width: 200, title: '提货时间',align:'center', sort: true, templet: '#create_timeTpl'}
                , {field: 'nick_name', width: 130, title: '买家昵称',align:'center', templet: '#nick_nameTpl'}
    ...
    function agree(id) {
        layer.open({
            ...
            shade: 0.8,
            area: ['500px', '50%'],
            content: ['CancelAdministration.jsp', 'no'],
            yes: function (id) {
                    ...
                    success: function (data) {
                        ...
                        if (data.success == 1) {
                            ...
                            for (var obj in array) {
                                ...
                                body.contents().find("#dispose_way_key").val(array[obj].dispose_way_key);
                                body.contents().find("#memo").text(array[obj].memo);
                                body.contents().find("#goodsTableOrderCode").text(array[obj].order_no);
                                break;
                            }
                        }
...
<script type="text/html" id="barDemo">
    <a class="layui-btn"
       ...
       onclick="Foo('{{d.order_no}}','{{d.id}}','{{d.logistics_numbers}}')">订单详情</a>
    <a class="layui-btn"
       style="height: 20px;line-height: 20px;width:100px;background-color:#1E9FFF;text-align:center;font-size: 12px;color: #FFFFFF;border-radius:20px;border:none"
       onclick="agree('{{d.id}}')">订单处理</a>
</script>

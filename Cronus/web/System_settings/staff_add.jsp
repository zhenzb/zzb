         ...
         <form >
            <div style="margin-top: 30px">
                ...
                <div class="layui-form-item"  style="margin-left: 30%">
                    ...
                    <div class="layui-input-block">
                        <input name="login_password" id="login_password" lay-verify="title" autocomplete="off"  class="layui-input" type="password" style="width:20%;border-color: #0C0C0C"><label id="login_password_error"></label>
                    </div>
                </div>
                <div class="layui-form-item"  style="margin-left: 30%">
                    <label class="layui-form-label"><label style="color: red">*</label>邮箱</label>
                    <div class="layui-input-block">
                        <input name="email" id="email" lay-verify="title" autocomplete="off"  class="layui-input" type="text" style="width:20%;border-color: #0C0C0C">
                    </div>
                </div>
                <div class="layui-form-item"  style="margin-left: 30%">

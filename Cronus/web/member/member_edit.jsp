    ...
    <form class="layui-form">
        ...
        <div class="layui-form-item" style="margin-top:10px;">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <input type="text" name="registration_time" id="registration_time" autocomplete="off" class="layui-input">
                </div>
                <div class="layui-inline">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-inline">
                    <button type="" class="layui-btn layui-btn-primary" onclick="shouzhi()">收支详情</button>
                </div>
        </div>
            <div class="layui-form-item">
            ...
            <%--<div class="layui-form-item">--%>
                <%--<div class="layui-input-block">--%>
                    ...
                    <%--<button class="layui-btn"   id="saveLogisticsBtn" lay-filter="demo1">确认</button>--%>
                <%--</div>--%>
            <%--</div>--%>
    </form>

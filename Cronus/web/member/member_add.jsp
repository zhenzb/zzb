        ...
        layui.use(['form', 'layedit', 'laydate'], function(){
           ...
           $('#saveMemberBtn').on('click', function(){
               ...
               if(pwd !=pwd2){
                ...
                $.ajax({
                    url: "${pageContext.request.contextPath}/member?method=MembersAdd",
           ...
           <%-- <input type="hidden" name="method" value="addMember">--%>
            <div class="layui-form-item">
                ...
                <div class="layui-inline">
                    ...
                    <div class="layui-input-inline">
                        <input type="text" name="phone" id="phone" required lay-verify="required|phone|number" autocomplete="off"
                               class="layui-input">
                    </div>
                </div>
            </div>
            ...
            <div class="layui-form-item">
                <div class="layui-inline">
                    ...
                    <div class="layui-input-block">
                        <input type="text" name="nick_name"  id="nick_name" required lay-verify="required" autocomplete="off"
                               class="layui-input">
                    </div>
                </div>
                <div class="layui-inline">
